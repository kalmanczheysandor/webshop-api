...
public class ProductListAndDeleteIT {
    ...
    void test_list_whenSuccessful() throws Exception {
        ...
        mockMvc.perform(get("/api/admin/products/")
                ...
                .andExpect(jsonPath("$[0].priceNet", is(115.0)))
                .andExpect(jsonPath("$[0].priceVat", is(25)))
                .andExpect(jsonPath("$[0].description", is("Nagyon finom")))
                .andExpect(jsonPath("$[0].active", is(true)))
                .andExpect(jsonPath("$[1].id", is(2)))
                .andExpect(jsonPath("$[1].name", is("Körte")))
                .andExpect(jsonPath("$[1].priceNet", is(1563.0)))
                .andExpect(jsonPath("$[1].priceVat", is(5)))
                ...
                .andExpect(jsonPath("$[2].priceNet", is(25.0)))
                .andExpect(jsonPath("$[2].priceVat", is(15)))
    ...
    void test_delete_whenSuccessful() throws Exception {
        ...
        mockMvc.perform(get("/api/admin/products/")
                ...
                .andExpect(jsonPath("$[1].priceNet", is(25.0)))
                .andExpect(jsonPath("$[1].priceVat", is(15)))
