...
public class OrderController {
    ...
    @Operation(summary = "Mentés", description = "Új megrendelés felvétele.")
    ...
    @Operation(summary = "Módosítás", description = "Korábban mentett megrendelés id általi elérése és mezőinek felülírása.")
    ...
    @GetMapping("/")
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Listázás", description = "Kilistázza az összes mentett megrendelést.")
    ...
    @GetMapping("/{orderId}")
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Lekérés", description = "Korábban mentett megrendelés id általi lekérése.")
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Törlés", description = "Korábban mentett megrendelés id általi törlése.")
    ...
    @ResponseStatus(HttpStatus.CREATED)
    @Operation(summary = "Mentés(tétel)", description = "Új megrendelési tétel felvétele.")
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Módosítás(tétel)", description = "Korábban mentett megrendelési tételt id általi elérése és mezőinek felülírása.")
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Listázás(tétel)", description = "Kilistázza az összes mentett megrendelési tételt.")
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Lekérés(tétel)", description = "Korábban mentett megrendelési tétel id általi lekérése.")
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Törlés(tétel)", description = "Korábban mentett megrendelési tétel id általi törlése.")
    public void deleteOrderById(@Parameter(description = "Megrendelés id", example = "5")
                                @PathVariable("orderId") int orderId,
                                @Parameter(description = "Tétel id", example = "9")
                                @PathVariable("orderItemId") int orderItemId) {
